...
},
{
  ...
  "body": " Modeling with differential equations   Modeling with first-order differential equations   Many applications present information about a quantity in a form that can be modeled by a first-order differential equation. Here is an outline of the steps to take in these settings.   Explicitly identify the quantity under consideration as a function of some other quantity , and give a name to this function: .    Translate the given information about into a first-order differential equation: . This is often the trickiest step!   Look for phrases that indicate rate of change of and translate these into equalities involving .    When there is a combination of components to the rate of change, a diagram may be useful.    Translate phrases like is proportional to as , where is the (possibly undetermined) constant of proportionality.       Ask yourself whether the differential equation is linear or separable. If so, use the appropriate technique to solve it in as general a form as you can.   If the equation is both separable and linear, you can use either method. It is often quicker to use the separation of variables technique.    If the differential equation is linear, make sure to bring it into standard form before using the integrating factor method.       Once you have solved you will have a formula for that includes some undetermined constants. If possible, use any additional information given about to determine these undetermined constants.        Mixing problem   A large tank in a pickle factory initially contains 50 liters of brine in which 20 kg of salt is dissolved. The mixture is kept uniform by stirring. Brine containing 0.2 kg of dissolved salt per liter enters the tank at a rate of 10 liters per minute. At the same time the mixture from the tank leaves at a rate of 6 liters per minute. How much salt is in the tank after 30 minutes.    First we make explicit the function we wish to determine: let be the amount of salt (in mg) in the tank after minutes.  Next we translate the given information into a differential equation for . To do so, we will have to translate statements about the concentration of salt into statements about the amount of salt. To this end, we let be the volume of the tank after minutes. Since fluid enters the tank at a rate of liters per minute and exits the tank at a rate of liters per minute, we see that the rate of change of is liters per second: , . It follows that . Since the initial volume is 50 liters, we have . Thus .  We can now write down a differential equation for : . Next we identify that the differential equation is linear. Following we first bring the differential equation into standard form: . Since is an antiderivative of , we set . Now compute , and conclude . Lastly, since initially there is 20 mg of salt in the tank, we have , which implies , or . Thus we have , from which it follows that the amount of salt after 30 minutes is .     Trout population   Left to their own devices, the population of trout in the Straits of Dudley increases at a rate of of the present population. A recent oil spill, however, has resulted in an ongoing depletion of the population: specifically, months after the spill the trout are dying off at a rate of fish per month.   Derive a differential equation describing trout population in the Strait of Dudley, considered as a function of the time (in months) since the oil spill. You may assume the oil spill has not affected the trout population's breeding habits.    Derive a formula for the population of trout months after the oil spill, assuming that at the moment of the spill there were six thousand fish in the Strait of Dudley.       First, we explicitly identify the function in question: let be the population of trout months after the spill. Now translate the given information into a differential equation for : we have . The differential equation is linear. Following , we first bring it into standard form . Skipping some details, we find that the integrating factor is and . The integral computation was done using integration by parts (followed by some algebra). We conclude that . Since the population is 6000 at the time of the spill, we have , which implies , or . We conclude that . As the first term tends toward 0, making behave like asymptotically like . So the long-term consequence of the oil spill is that the population, which would have grown as in the absence of the oil spill, grows instead like .   Trout populatio       Spreading rumor   A false rumor is being spread within a certain university community. Let be the percentage (from 0 to 100) of the community that has heard the rumor days after the rumor is introduced. Assume that percentage of the population that has heard the rumor grows at a rate proportional to the product of the current percentage of those in the know with the current percentage of those not in the know.   Write down a differential equation for . Use as your constant of proportionality.    Derive a formula for assuming that at time five percent of the population has heard the rumor. Your answer will be expressed in terms of and .    Investigate the long-term behavior of the rumor's spread. Is there a time when the entire population has heard the rumor?       We have . The differential equation is separable (and not linear). We solve using the separation of variables technique: . Since initially of the population knows the rumor, we have , and thus . This implies , and thus , where .  This is called a logistic growth function. Since is decreasing, we see that is increasing. Furthermore, we have . Thus as time passes the percentage of the population that have heard the rumor increases and approaches 100 percent asymptotically.   Percentage that has heard the rumor       "
},
{
...
},
{
  ...
  "body": " Trout population   Left to their own devices, the population of trout in the Straits of Dudley increases at a rate of of the present population. A recent oil spill, however, has resulted in an ongoing depletion of the population: specifically, months after the spill the trout are dying off at a rate of fish per month.   Derive a differential equation describing trout population in the Strait of Dudley, considered as a function of the time (in months) since the oil spill. You may assume the oil spill has not affected the trout population's breeding habits.    Derive a formula for the population of trout months after the oil spill, assuming that at the moment of the spill there were six thousand fish in the Strait of Dudley.       First, we explicitly identify the function in question: let be the population of trout months after the spill. Now translate the given information into a differential equation for : we have . The differential equation is linear. Following , we first bring it into standard form . Skipping some details, we find that the integrating factor is and . The integral computation was done using integration by parts (followed by some algebra). We conclude that . Since the population is 6000 at the time of the spill, we have , which implies , or . We conclude that . As the first term tends toward 0, making behave like asymptotically like . So the long-term consequence of the oil spill is that the population, which would have grown as in the absence of the oil spill, grows instead like .   Trout populatio     "
},
{
  "id": "example-100",
  "level": "2",
