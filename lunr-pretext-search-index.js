...
},
{
  ...
  "body": " Improper integrals: convergence tests   Direct comparison test   Let and be nonnegative functions on an interval , and suppose for all in . If the integral of over converges, then the integral of over converges. Using logical notation: .  Equivalently, using the contrapositive of , we have .     Limit comparison test   Let and be continuous and positive on the interval .   If and with , then .    If and with , then .    If and with , then .    If and with , then .        Comparison test   Decide whether converges.         Comparison test   Decide whether converges.         Comparison test   Decide whether converges.         Comparison test   Let be any fixed irreducible quadratic polynomial with . Decide whether exists.        "
},
{
  "id": "th_direct_comp",
  "level": "2",
