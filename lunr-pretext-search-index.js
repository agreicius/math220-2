...
},
{
  ...
  "number": "1.9.7",
  "title": "Disc example.",
  "body": " Disc example   Let , let be the region in the first quadrant lying below the graph of and above the line with equation , and let be the solid obtained by rotating about .    Compute .    Sketch the solid . How else could we have computed the volume in (a)?         Disk diagram    "
},
{
  "id": "eg_washer",
  "level": "2",
  ...
  "body": " Washer example   Let be the region enclosed by the line and the parabola , and let be the solid obtained revolving about the -axis. Sketch and compute the volume of .       Washer diagram    "
},
{
  "id": "s_inverse",
  "level": "1",
